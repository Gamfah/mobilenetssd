...
lineaccesstoken = '6ApMT+PMagX4zt0Vw8ha0Zbd0/kNRxHLmMUOiy1AHIl6iKI14yH1IpJBatkvwPNtSf6k3f9xZVkZGPkXTfk0UDE4L6Fd8zjJy2HVSGUaipyBsiYO506+t7WdQUUZFe2Ms8P3p5r9lx6I23Acw2VWcgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี" :
            replyObj = TextSendMessage(text="ดีจร้าาาา")
        elif msg == "กินข้าวไหม" :
...
url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/ba2f4362-7bb0-446d-af3d-1631957355e1"
